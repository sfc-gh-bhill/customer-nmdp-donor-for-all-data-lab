...
grounded in published CIBMTR/LSC statistics and the "Donor for All" initiative.
...
# US transplant center regions (based on CIBMTR reporting centers)
TRANSPLANT_CENTERS = [
    ...
    {"id": "TC005", "region": "Southeast", "state": "NC", "name": "Duke University Medical Center"},
    ...
    {"id": "TC008", "region": "Midwest", "state": "WI", "name": "Medical College of Wisconsin"},
    ...
    {"id": "TC013", "region": "West", "state": "CA", "name": "Stanford Medical Center"},
...
RESEARCH_TEMPLATES = [
    ...
    "Case flagged for {study_area} analysis. {age}yo {race} patient with {diagnosis} received {donor_type} graft ({hla}/8 match). {outcome_detail}. {svi_note}. Data contributed to CIBMTR registry.",
]
    ...
    if note_type == "POST_TRANSPLANT_FOLLOWUP":
        ...
        return template.format(
            ...
            note=random.choice(["Flagged for multivariable analysis", "Include in annual outcomes report",
                                 "Relevant for upcoming CIBMTR publication", "Cross-reference with LSC registry data"]),
